...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/PocPdfEngine
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/PocPdfEngine)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/PocPdfEngine`
* `site/tests/integration/Espo/Modules/PocPdfEngine`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/PocPdfEngine/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/PocPdfEngine/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/poc-pdf-engine/lib/init.js"
        ]
    }
    ```
